...
namespace MarketCore.FlowSense
{
    ...
    {
        /// <summary>
        /// Quando verdadeiro: sem fluxo por corretora nem heurísticas que assumem ofertas individuais
        /// (renewable no book, spoof/iceberg/stop hunt nos detectores). Adequado a livro só com quantidade agregada por preço.
        /// </summary>
        public bool PreferAggregatedBookSignals { get; set; } = true;

        // ════════════════════════════════════════════
        // GRUPO 1 - Pesos dos 4 componentes (somam 1.0)
        // ════════════════════════════════════════════
        public double WeightBrokerFlow    { get; set; } = 0.0;
        public double WeightFluxoDireto   { get; set; } = 0.45;
        public double WeightBook          { get; set; } = 0.35;
        ...
        public double DetectorSpoofPenalty      { get; set; } = 0.0;

        /// <summary>Bônus aplicado quando Iceberg é detectado</summary>
        public double DetectorIcebergBonus      { get; set; } = 0.0;
        ...
        public double DetectorStopHuntPenalty   { get; set; } = 0.0;
